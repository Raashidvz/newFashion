...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2024 at 07:08 PM
...
(31, 7, NULL, 57, 'default', '', 'MINI', 'SLEEVELESS', '');
...
(1, 'Lace', '../fabrics/lace.jpeg', 'Delicate and romantic, perfect for bridal and special occasions.', 500.00, 24.00, '2024-09-18 15:24:26', 1, 'Out of Stock'),
(2, 'Silk', '..\\fabric\\silk.jpg', 'Luxurious and elegant, perfect for evening wear.', 700.00, 0.00, '2024-09-19 07:49:27', 1, 'Low Stock'),
(3, 'Cotton', '..\\fabric\\cotton1.jpg', 'Comfortable and breathable, ideal for casual dresses.', 300.00, 22.00, '2024-09-19 07:51:47', 1, 'In Stock'),
...
(57, 34, 7, NULL, 0.00, 0.00, 0.00, 0.00, '2024-11-01 13:55:34');
...
CREATE TABLE `orders` (
  ...
  `TOTAL_PRICE` decimal(10,2) NOT NULL,
  `CATEGORY` enum('FABRIC_PURCHASE','DRESS_PURCHASE','DRESS_CUSTOMIZATION','FULLY_CUSTOMIZATION') NOT NULL,
  `ESTIMATED_DELIVERY_DATE` date DEFAULT NULL,
  `ACTUAL_DELIVERY_DATE` date DEFAULT NULL,
  `CREATED_AT` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(58, 34, 7, NULL, 31, 'PENDING', 'm', 1, 2199.00, 'DRESS_CUSTOMIZATION', '2024-11-10', '2024-11-15', '2024-11-01 13:55:34'),
(59, 34, 4, NULL, NULL, 'PENDING', 'xs', 1, 2500.00, 'DRESS_PURCHASE', '2024-11-10', '2024-11-15', '2024-11-01 13:56:09'),
(60, 34, NULL, 5, NULL, 'PENDING', '', 5, 1750.00, 'FABRIC_PURCHASE', '2024-11-04', '2024-11-06', '2024-11-01 14:22:02');
...
(3, 'sulu', 'sulu', 'sulfth@gmail.com', '9876543', 'CUSTOMER', '', '2024-09-14 11:35:19', NULL, 0),
(4, 'ann', 'aa', 'ann@gmail.com', '763453256', 'CUSTOMER', '', '2024-09-14 11:58:57', NULL, 0),
(5, 'shukoor', 'shukoor@gmail.com', 'shukoor@gmail.com', '7548754841', 'STAFF', NULL, '2024-10-24 00:20:14', NULL, 0),
(6, 'maya', 'maya@gmail.com', 'maya@gmail.com', '9856584587', 'STAFF', NULL, '2024-10-24 00:20:35', NULL, 0),
(7, 'shuhaib', 'shuhaib@gmail.com', 'shuhaib@gmail.com', '7958659857', 'STAFF', NULL, '2024-10-24 00:21:15', NULL, 0),
(34, 'sss', 'ssssss', 'ss@gmail.com', '98765432', 'CUSTOMER', 'saghdgsadhj', '2024-11-01 12:04:42', NULL, 0);
...
--
ALTER TABLE `fabrics`
  MODIFY `FABRIC_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `measurements`
  MODIFY `MEASUREMENT_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
